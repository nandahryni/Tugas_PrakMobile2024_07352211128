  ...
  final List<Map<String, dynamic>> freelancers = [
    {
      ...
      "rating": 4.9,
      "image": "assets/images/amu WEE!!!.jpg"
    },
    {
      "name": "Ningning",
      "profession": "Beautician",
    ...
    },
    {
      ...
      "profession": "Beautician",
      "rating": 4.9,
      "image": "assets/images/sillycat.jpg"
    },
    {
      "name": "Mcat",
      "profession": "Beautician",
      "rating": 4.9,
      "image": "assets/images/mewingcat.jpg"
    },
  ];
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        const SizedBox(height: 10),
        ServiceCard(
          imageUrl: 'assets/images/giselle.jpg',
        ...
        ServiceCard(
          imageUrl: 'assets/images/batcat.jpg',
          name: 'Miss Zachary Will',
          role: 'Beautician',
          description: 'Doloribus saepe aut necessitatibus qui.',
          rating: 4.9,
  ...
  Widget build(BuildContext context) {
    return Column(
        children: [
          BestBookingCard(
            imageUrl: 'assets/images/batcat.jpg',
            profileUrl: 'assets/images/cat witch.jpg',
            name: 'Miss Zachary Will',
            role: 'Beautician',
            ...
            Stack(
              children: [
                ClipRRect(
                  ...
                  child: Image.asset(
                    'assets/images/doll.jpg', // Ganti dengan path gambar Anda
                    height: 230,
                    width: double.infinity,
                    fit: BoxFit.cover,
                  ),
